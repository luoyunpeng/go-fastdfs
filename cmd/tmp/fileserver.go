...
// Read: CrossOrigin add cross info to header
...
// Radd: SetDownloadHeader add dowoload info to header
...
func (this *Server) upload(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		if scene == "" {
			scene = Config().DefaultScene // Read: scene="default"
		}
		if output == "" {
...
func (this *Server) Main() {
	...
	if groupRoute == "" {
		// Read: if no params given, redirect to upload page
	...
	// TODO: in ali-cloud, peer is wrong
